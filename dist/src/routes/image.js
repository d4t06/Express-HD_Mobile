...
imageRouter.use(requireAuth_1.default, (0, requireRole_1.default)('ADMIN'));
imageRouter.post("/", upload.single("image"), image_1.default.uploadFile);
imageRouter.post("/url/:imageUrl", upload.single("image"), image_1.default.uploadUrl);
