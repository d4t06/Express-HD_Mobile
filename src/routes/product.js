...
productRouter.get("/search", product_1.default.search);
productRouter.get("/:productAscii", product_1.default.findOne);
// productRouter.use();
...
productRouter.put("/:productAscii", product_1.default.update);
productRouter.delete("/:productAscii", product_1.default.delete);
